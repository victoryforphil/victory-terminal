...
mod tests {
    ...
    fn test_option_builder_basic_string() {
        ...
        assert_eq!(
            option.value,
            ConnectionOptionType::String("Test String".to_owned())
        );
    }
    ...
    fn test_option_builder_basic_selection() {
        let option = ConnectionOptionBuilder::new()
            ...
            .description("Test description".to_owned())
            .value(ConnectionOptionType::Selection(SelectionData {
                options: vec!["Test1".to_owned(), "Test2".to_owned()],
                selected: 0,
            }))
            .build();
        ...
        assert_eq!(
            option.value,
            ConnectionOptionType::Selection(SelectionData {
                options: vec!["Test1".to_owned(), "Test2".to_owned()],
                selected: 0
            })
        );
